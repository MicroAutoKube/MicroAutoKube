...
const Profile: React.FC<ProfileProps> = ({ cluster }) => {
  ...
  // Default status (replace with real status logic if available)
  ...
  return (
    <div className="bg-black/50 rounded-xl p-5 text-white shadow-xl hover:bg-black hover:border-blue-700 border border-white/10">
